    ...
    render() {
        ...
        const tabs =
            <ul className="nav nav-tabs edition-tabs">
                <li onClick={this.changeView.bind(this,true)} className={this.state.showRML  ? 'active' : ''}>
                    <a href="#">Edit RML</a>
                </li>
        ...
        const editElements = <div>
            ...
            {this.props && <span>Last edited on { Moment(this.props.edition.date).format('DD/MM/YYYY, HH:mm:ss') } by
            { this.props.edition.username}</span>}
