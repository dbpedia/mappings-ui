    ...
    render() {
            ...
            return (
                <section className="container">
                    <h1 className="page-header">
                        <Link to="/admin/account-groups">Account Groups</Link> / loading...
                    </h1>
                </section>
            );
        }
        ...
        if (this.state.details.showFetchFailure) {
            return (
                <section className="container">
                    <h1 className="page-header">
                        <Link to="/admin/account-groups">Account Groups</Link> / Error
                    </h1>
        ...
        return (
            <section className="container">
                <h1 className="page-header">
                    <Link to="/admin/account-groups">Account Groups</Link> / {name}
                </h1>
                <div className="row">
