...
lab.experiment('Posts Create New Form', () => {
    ...
    lab.test('it focuses on the title field when the component is update and showing', (done) => {
        ...
        defaultProps.ref.impl = function (form) {
            ...
            form.els.title.input.onfocus = function () {
