...
const Constants = require('../../../../../client/pages/groups/search/constants');
const Lab = require('lab');
const Proxyquire = require('proxyquire');
const React = require('react');
const ReactDOM = require('react-dom');
const ReactTestUtils = require('react-dom/test-utils');
const Store = require('../../../../../client/pages/groups/search/store');
...
const Page = Proxyquire('../../../../../client/pages/groups/search/index.jsx', {
...
lab.experiment('Account Groups Search Page', () => {
