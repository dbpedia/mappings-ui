...
const Constants = require('../../../../../client/pages/mappings/list/constants');
const Lab = require('lab');
const Proxyquire = require('proxyquire');
const React = require('react');
const ReactDOM = require('react-dom');
const ReactTestUtils = require('react-dom/test-utils');
const Store = require('../../../../../client/pages/mappings/list/store');
...
const Page = Proxyquire('../../../../../client/pages/mappings/list/index.jsx', {
...
lab.experiment('Mappings  Search Page', () => {
